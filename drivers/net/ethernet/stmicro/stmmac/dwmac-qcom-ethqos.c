...
/*
 * Retrieve struct dw_xpcs * from the XPCS platform device referenced by
 * the ethernet node's pcs-handle property and wire it into stmmac's
 * phylink PCS slot.  Called from stmmac_pcs_setup() via plat_dat->pcs_init.
 */
